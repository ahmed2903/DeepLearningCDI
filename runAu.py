...
def Predict():
	...
	predict.SetExpData('expdata.npy', mask=700, square_root=True)
	predict.SetOutputFile('AuTest.npy')
	predict.SetSupport('supportML.npy')
	predict.InitialiseWeights(nn.init.kaiming_normal_, mode='fan_in', nonlinearity='leaky_relu')
	#predict.SetTrainedNN("/scratch/ahmm1g15/MLCode/2023-05-19_12.59/CP100_2023-05-19_12.59.pth")
