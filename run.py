...
def Train():
	cnn = CNNTrain()
	cnn.SetDevice('cuda')
	cnn.SetInputData('fs_amps.npy') # noise is a normal random distribution with its mean at mu/2
...
def Predict():
	...
	predict.SetExpData('expdata_ML2.npy', mask=140, square_root=True)
	predict.SetTrainedNN("CP100_2022-08-24_12.41.pth")
	predict.SetOutputFile('VO325')
	predict.SetLRStepSize(50)
	predict.AddLR(1e-3)
	predict.AddLR(1e-6)
	predict.AddLR(1e-8)
