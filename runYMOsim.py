...
def Predict():
	...
	predict.SetExpData('/scratch/ahmm1g15/MLCode/YMO_DiffSim_002.npy', mask=1, square_root=True, validation = True)	
	predict.SetOutputFile('OutputNoSupp.npy')
	predict.SetSupport('support3.npy')
	predict.SetTrainedNN("/scratch/ahmm1g15/MLCode/2023-06-01_1Dil_D4/CP50_2023-06-01_22.25.pth")
	#predict.SetTrainedNN("CP100_2023-06-01_17.26.pth")
